...
def get_answer(message):
    ...
    bot.send_message(message.chat.id, '{} where are you?'.format(sname), reply_markup=rm)
...
def test_callback(query):
    ...
    bot.edit_message_text(text= "eh i am {} and i am ".format(sname) + str(ans),chat_id =query.message.chat.id ,message_id = query.message.message_id)
